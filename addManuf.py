...
class addManufDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        super(addManufDialog, self).__init__(parent)
        ...
        self.setWindowTitle(_translate("Dialog", "Добавление производителя"))
        self.label.setText(_translate("Dialog", "Производитель"))
