...
class addGoodDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.resize(571, 362)
        self.setMinimumSize(QtCore.QSize(571, 362))
        self.setMaximumSize(QtCore.QSize(571, 362))
    ...
    def addLogic(self):
        ...
        if check:
            ...
            cur = db.cursor()
            sql = (
                'insert into goods (model, price, picture, count, opinion, weight, x, y, z, categories_idcategories, '
                'manufacturers_idmanufacturers) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)')
            val = (model, price, picture, count, opinion, weight, x, y, z, category, manufacturer)
            cur.execute(sql, val)
            db.commit()
            db.close()
            self.close()
